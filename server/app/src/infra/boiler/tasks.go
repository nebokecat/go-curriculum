...
func FindTaskP(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) *Task {
...
func FindTaskGP(ctx context.Context, iD int64, selectCols ...string) *Task {
...
func (o *Task) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...)
}

// UpsertGP attempts an insert, and does an update or ignore on conflict. Panics on error.
func (o *Task) UpsertGP(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) {
...
func (o *Task) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(taskPrimaryKeyColumns) == 0 {
				return errors.New("boiler: unable to upsert tasks, could not build conflict column list")
			}
...
func (o *Task) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("boiler: no Task provided for reload")
	}
...
func (o *TaskSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("boiler: empty TaskSlice provided for reload all")
	}
...
func TaskExistsP(ctx context.Context, exec boil.ContextExecutor, iD int64) bool {
...
func TaskExistsGP(ctx context.Context, iD int64) bool {
